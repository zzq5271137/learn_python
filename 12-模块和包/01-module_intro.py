...
"""
为什么需要模块和包:
随着项目越来越大, 所有代码都放在一个文件中, 已经不能满足我们的需求了; 这是就需要对代码进行整理了,
...
3. from 模块名 import xxx:
   ...
   注: 这里的"模块名"可能会包含路径, 比如"包名1.包名2.模块名", 其中, 模块在包2下, 包2在包1下
...
才能被视为一个包; 在同一个包中的模块如果要互相导入, 则只能通过相对的方式进行导入, 即: from . import xxx
"""
